...
const presetLive2dMyModelUrl = new URL('../assets/live2d/models/my_model.zip', import.meta.url).href
...
const displayModelsPresets: DisplayModel[] = [
  ...
  { id: 'preset-live2d-3', format: DisplayModelFormat.Live2dZip, type: 'url', url: presetLive2dMyModelUrl, name: 'My Model', previewImage: presetLive2dPreview, importedAt: 1733113886840 },
